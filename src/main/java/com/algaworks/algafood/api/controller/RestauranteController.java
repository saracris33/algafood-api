...
public class RestauranteController {
	...
	@PutMapping("/{restauranteId}/ativacoes")
	@ResponseStatus(HttpStatus.NO_CONTENT)
	...
	@DeleteMapping("/{restauranteId}/ativacoes")
	@ResponseStatus(HttpStatus.NO_CONTENT)
	...
	public RestauranteModel atualizarParcial(@PathVariable Long restauranteId, @RequestBody Map<String, Object> campos,
		...
		RestauranteInput restauranteAtualInput = restauranteModelAssembler.toInput(restauranteAtual);
